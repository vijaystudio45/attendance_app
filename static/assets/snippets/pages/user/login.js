    ...
    var e = $("#m_login"),
        ...
        s = function() {
            $("#m_login_signup_submit").click(function(a) {
                a.preventDefault();
                var formUrlSignup = $('#signup_form').attr('action');
                var r = $(this),
                    n = $(this).closest("form");
                n.validate({
                    rules: {
                    ...
                    success: function(a, l, s, o) {
                        if (a.status == 'success') {
                            ...
                            $("#m_login_signup_submit").removeClass("m-loader m-loader--right m-loader--light");                               $("#m_login_signup_submit").prop("disabled", false);
